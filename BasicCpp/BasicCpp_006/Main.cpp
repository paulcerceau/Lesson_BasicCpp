...
int main()
{
	...
	cout << "Your Strength is at " << abilities["Strength"] << " and your Intelligence at " << abilities["Intelligence"] << ". How is that 0? Oh my, I forgot to roll your Intelligence!" << endl;

	// Add the forgotten ability
	abilities["Intelligence"] = ((rand() % 6) + 1) * 3;

	cout << "Now your Intelligence is at " << abilities["Intelligence"] << ". Better!" << endl;
