...
// Add coins in a purse. But the coins are lost in the purse...
void AddCoinsInLeakyPurse(vector<string> purse, int coinsToAdd)
{
...
int main()
{
	...
	// -- The leaky purse --
	cout << "Looks like you also have a little bit of money. Let's see what you have in your purse." << endl;

	vector<string> purse{ "Coin", "Coin", "Coin" };

	cout << "There are " << purse.size() << " coins." << endl;
